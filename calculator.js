...
.config(function($translateProvider) {
 $translateProvider.translations('en', {
    ...
    KM: 'km',
    TRIPSMADEPERYEAR: 'Trips Made Per Year (Round trip to work = 2 trips per day x 5 days per week x 52 weeks per year = 520)',
 ...
 $translateProvider.translations('th', {
    ...
    KM: 'กม.',
    TRIPSMADEPERYEAR: 'จำนวนเที่ยวต่อปี (ตัวอย่าง: ไปกลับที่ทำงาน = 2 เที่ยวต่อวัน x 5วันต่ออาทิตย์ x 52อาทิตย์ต่อปี = 520)',
